...
DatabaseReference databaseReference= FirebaseDatabase.getInstance().getReferenceFromUrl("https://chatbox-fd262-default-rtdb.firebaseio.com/");  //getting firebase database reference from url
...
private  final List<String> doneBoxes= new ArrayList<>();   //clicked boxes positions by users so users won't select the box again
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting the code form playerName activity.
        final String getPlayerName = getIntent().getStringExtra("code");
                ...
                if (snapshot.hasChild("player_id")) {
                    ...
                    if (getWinPlayerId.equals(playerUniqueId)) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(MainActivity.this, "Opponent won the game", Toast.LENGTH_SHORT).show();
